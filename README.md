# Bricks.Structure.Event

Пакет реализует логику событийной модели взаимодействия компонентов системы 
благодаря trait, который может быть встроен в тело класса, способного 
генерировать события и регистрировать их слушателей.
...
[исходные коды]: https://github.com/Bashka/bricks_structure_event/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_structure_event/issues
